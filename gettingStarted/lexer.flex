...
"/"                     {if(USE_LEX_ONLY) {printf("DIVOP ");} else {return yy::parser::make_RP(yytext);}}
"!"                     {if(USE_LEX_ONLY) {printf("EXCLAMATION MARK ");} else {return yy::parser::make_RP(yytext);}}
...
"<"                     {if(USE_LEX_ONLY) {printf("LESS THAN ");} else {return yy::parser::make_RP(yytext);}}
">"                     {if(USE_LEX_ONLY) {printf("GREATER THAN ");} else {return yy::parser::make_RP(yytext);}}
"<="                     {if(USE_LEX_ONLY) {printf("LESS EQUAL ");} else {return yy::parser::make_RP(yytext);}}
">="                     {if(USE_LEX_ONLY) {printf("GREATER EQUAL ");} else {return yy::parser::make_RP(yytext);}}
"=="                     {if(USE_LEX_ONLY) {printf("Equality Operator ");} else {return yy::parser::make_RP(yytext);}}
...
"{"                   {if(USE_LEX_ONLY) {printf("Left Brac ");} else {return yy::parser::make_RP(yytext);}}
"}"                   {if(USE_LEX_ONLY) {printf("right Brac ");} else {return yy::parser::make_RP(yytext);}}
...
"["                   {if(USE_LEX_ONLY) {printf("Left SQR Brac ");} else {return yy::parser::make_RP(yytext);}}
"]"                   {if(USE_LEX_ONLY) {printf("Right SQR Brac ");} else {return yy::parser::make_RP(yytext);}}
";"                   {if(USE_LEX_ONLY) {printf("SemiColon ");} else {return yy::parser::make_RP(yytext);}}
","                   {if(USE_LEX_ONLY) {printf("COMMA ");} else {return yy::parser::make_RP(yytext);}}
"_"                   {if(USE_LEX_ONLY) {printf("UnderScore ");} else {return yy::parser::make_RP(yytext);}}
...
":"                   {if(USE_LEX_ONLY) {printf("COLON ");} else {return yy::parser::make_RP(yytext);}}
"int"                   {if(USE_LEX_ONLY) {printf("INT ");} else {return yy::parser::make_RP(yytext);}}
