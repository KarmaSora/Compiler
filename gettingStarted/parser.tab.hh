...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    MORE_THAN = 267,               // MORE_THAN
    EQUAL = 268,                   // EQUAL
    TRUE = 269,                    // TRUE
    FALSE = 270,                   // FALSE
    THIS = 271,                    // THIS
    NEW = 272,                     // NEW
    LEFT_BRACKET = 273,            // LEFT_BRACKET
    RIGHT_BRACKET = 274,           // RIGHT_BRACKET
    DOT = 275,                     // DOT
    LENGTH = 276,                  // LENGTH
    EXCLAMATION_MARK = 277,        // EXCLAMATION_MARK
    LEFT_CURLY = 278,              // LEFT_CURLY
    RIGHT_CURLY = 279,             // RIGHT_CURLY
    ASSIGN = 280,                  // ASSIGN
    MORE_THAN_EQUAL = 281,         // MORE_THAN_EQUAL
    ...
    STRING = 290,                  // STRING
    VOID = 291,                    // VOID
    SYSTEM_OUT_PRINTLN = 292,      // SYSTEM_OUT_PRINTLN
    WHILE = 293,                   // WHILE
    EXTENDS = 294,                 // EXTENDS
    RETURN = 295,                  // RETURN
    STATIC = 296,                  // STATIC
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_AND = 9,                               // AND
        S_OR = 10,                               // OR
        S_LESS_THAN = 11,                        // LESS_THAN
        S_MORE_THAN = 12,                        // MORE_THAN
        S_EQUAL = 13,                            // EQUAL
        S_TRUE = 14,                             // TRUE
        S_FALSE = 15,                            // FALSE
        S_THIS = 16,                             // THIS
        ...
        S_DOT = 20,                              // DOT
        S_LENGTH = 21,                           // LENGTH
        S_EXCLAMATION_MARK = 22,                 // EXCLAMATION_MARK
        S_LEFT_CURLY = 23,                       // LEFT_CURLY
        S_RIGHT_CURLY = 24,                      // RIGHT_CURLY
        S_ASSIGN = 25,                           // ASSIGN
        S_MORE_THAN_EQUAL = 26,                  // MORE_THAN_EQUAL
        S_LESS_THAN_EQUAL = 27,                  // LESS_THAN_EQUAL
        S_UNDER_SCORE = 28,                      // UNDER_SCORE
        ...
        S_STRING = 35,                           // STRING
        S_VOID = 36,                             // VOID
        S_SYSTEM_OUT_PRINTLN = 37,               // SYSTEM_OUT_PRINTLN
        S_WHILE = 38,                            // WHILE
        S_EXTENDS = 39,                          // EXTENDS
        S_RETURN = 40,                           // RETURN
        S_STATIC = 41,                           // STATIC
        S_SEMI_COLON = 42,                       // SEMI_COLON
        S_COMMA = 43,                            // COMMA
        S_DIVIDE = 44,                           // DIVIDE
        ...
        S_singleClassDeclaration = 51,           // singleClassDeclaration
        S_type = 52,                             // type
        S_mainClass = 53,                        // mainClass
        S_varDeclaration = 54,                   // varDeclaration
        S_reqVarDeclaration = 55,                // reqVarDeclaration
        S_retSTMT = 56,                          // retSTMT
        S_reqVarOrStmt = 57,                     // reqVarOrStmt
        S_parameters = 58,                       // parameters
        S_parameter_list = 59,                   // parameter_list
        S_methodDeclaration = 60,                // methodDeclaration
        S_reqMethodDeclaration = 61,             // reqMethodDeclaration
        S_statement = 62,                        // statement
        S_reqStatement = 63,                     // reqStatement
        S_expression = 64,                       // expression
        S_dotExpTest = 65,                       // dotExpTest
        S_arguments = 66,                        // arguments
        S_argument_list = 67,                    // argument_list
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_MORE_THAN (std::string v)
      {
        return symbol_type (token::MORE_THAN, std::move (v));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_LEFT_CURLY (std::string v)
      {
        return symbol_type (token::LEFT_CURLY, std::move (v));
      }
#else
      static
      symbol_type
      make_LEFT_CURLY (const std::string& v)
      {
        return symbol_type (token::LEFT_CURLY, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RIGHT_CURLY (std::string v)
      {
        return symbol_type (token::RIGHT_CURLY, std::move (v));
      }
#else
      static
      symbol_type
      make_RIGHT_CURLY (const std::string& v)
      {
        return symbol_type (token::RIGHT_CURLY, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_MORE_THAN_EQUAL (std::string v)
      {
        return symbol_type (token::MORE_THAN_EQUAL, std::move (v));
      }
#else
      static
      symbol_type
      make_MORE_THAN_EQUAL (const std::string& v)
      {
        return symbol_type (token::MORE_THAN_EQUAL, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LESS_THAN_EQUAL (std::string v)
      {
        return symbol_type (token::LESS_THAN_EQUAL, std::move (v));
      }
#else
      static
      symbol_type
      make_LESS_THAN_EQUAL (const std::string& v)
      {
        return symbol_type (token::LESS_THAN_EQUAL, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_UNDER_SCORE (std::string v)
      {
        return symbol_type (token::UNDER_SCORE, std::move (v));
      }
#else
      static
      symbol_type
      make_UNDER_SCORE (const std::string& v)
      {
        return symbol_type (token::UNDER_SCORE, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_SEMI_COLON (std::string v)
      {
        return symbol_type (token::SEMI_COLON, std::move (v));
      }
#else
      static
      symbol_type
      make_SEMI_COLON (const std::string& v)
      {
        return symbol_type (token::SEMI_COLON, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
